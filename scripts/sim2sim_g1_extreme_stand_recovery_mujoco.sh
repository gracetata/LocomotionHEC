...
TARGET_POSITION_LIMITER_ENABLE=${TARGET_POSITION_LIMITER_ENABLE:-False}
FALL_SAFETY_ENABLE=${FALL_SAFETY_ENABLE:-True}
FALL_SAFETY_ROOT_HEIGHT_M=${FALL_SAFETY_ROOT_HEIGHT_M:-0.45}
STABLE_DAMPING_INITIAL_GAIN=${STABLE_DAMPING_INITIAL_GAIN:-1.1}
STABLE_DAMPING_INITIAL_DURATION_S=${STABLE_DAMPING_INITIAL_DURATION_S:-3.0}
STABLE_DAMPING_GAIN=${STABLE_DAMPING_GAIN:-1.05}
STABLE_DAMPING_BLEND_IN_S=${STABLE_DAMPING_BLEND_IN_S:-0.50}
STABLE_DAMPING_BLEND_OUT_S=${STABLE_DAMPING_BLEND_OUT_S:-0.05}
RECOVERY_DAMPING_BLEND=${RECOVERY_DAMPING_BLEND:-0.25}
SEVERE_DISTURBANCE_GRAVITY_XY=${SEVERE_DISTURBANCE_GRAVITY_XY:-0.20}
FALL_SAFETY_DAMPING_GAIN=${FALL_SAFETY_DAMPING_GAIN:-1.0}
TARGET_RECOVERY_LIMIT_SCALE=${TARGET_RECOVERY_LIMIT_SCALE:-4.0}
TARGET_SMOOTHING_ALPHA=${TARGET_SMOOTHING_ALPHA:-1.0}
...
TARGET_LEG_JERK_LIMIT_RAD_S3=${TARGET_LEG_JERK_LIMIT_RAD_S3:-7500.0}
TARGET_WAIST_JERK_LIMIT_RAD_S3=${TARGET_WAIST_JERK_LIMIT_RAD_S3:-3125.0}
TARGET_ARM_JERK_LIMIT_RAD_S3=${TARGET_ARM_JERK_LIMIT_RAD_S3:-5000.0}
GENERATE_PUSH_PLOTS=${GENERATE_PUSH_PLOTS:-False}
...
if is_true "${SUITE}"; then
    ...
    for profile in "${profiles[@]}"; do
        for seed in "${seeds[@]}"; do
            ...
            TARGET_RECOVERY_LIMIT_SCALE="${TARGET_RECOVERY_LIMIT_SCALE}" \
            ...
            TARGET_LEG_JERK_LIMIT_RAD_S3="${TARGET_LEG_JERK_LIMIT_RAD_S3}" \
            TARGET_WAIST_JERK_LIMIT_RAD_S3="${TARGET_WAIST_JERK_LIMIT_RAD_S3}" \
            TARGET_ARM_JERK_LIMIT_RAD_S3="${TARGET_ARM_JERK_LIMIT_RAD_S3}" \
...
echo "Low-jerk control: enabled=${TARGET_LIMITER_ENABLE}, target_position_limiter=${TARGET_POSITION_LIMITER_ENABLE}"
echo "Post-fall safety: enabled=${FALL_SAFETY_ENABLE}, root_height<${FALL_SAFETY_ROOT_HEIGHT_M}m, damping_gain=${FALL_SAFETY_DAMPING_GAIN}"
echo "Stable damping : initial=${STABLE_DAMPING_INITIAL_GAIN} for ${STABLE_DAMPING_INITIAL_DURATION_S}s, steady=${STABLE_DAMPING_GAIN}, blend=${STABLE_DAMPING_BLEND_IN_S}/${STABLE_DAMPING_BLEND_OUT_S}s, severe_floor=${RECOVERY_DAMPING_BLEND}@gravity_xy>=${SEVERE_DISTURBANCE_GRAVITY_XY}"
...
echo "  jerk          : leg=${TARGET_LEG_JERK_LIMIT_RAD_S3}, waist=${TARGET_WAIST_JERK_LIMIT_RAD_S3}, arm=${TARGET_ARM_JERK_LIMIT_RAD_S3} rad/s^3"
...
G1_AMP_EXTREME_STAND_TARGET_POSITION_LIMITER_ENABLE="${TARGET_POSITION_LIMITER_ENABLE}" \
G1_AMP_EXTREME_STAND_FALL_SAFETY_ENABLE="${FALL_SAFETY_ENABLE}" \
G1_AMP_EXTREME_STAND_FALL_SAFETY_ROOT_HEIGHT_M="${FALL_SAFETY_ROOT_HEIGHT_M}" \
G1_AMP_EXTREME_STAND_STABLE_DAMPING_INITIAL_GAIN="${STABLE_DAMPING_INITIAL_GAIN}" \
G1_AMP_EXTREME_STAND_STABLE_DAMPING_INITIAL_DURATION_S="${STABLE_DAMPING_INITIAL_DURATION_S}" \
G1_AMP_EXTREME_STAND_STABLE_DAMPING_GAIN="${STABLE_DAMPING_GAIN}" \
G1_AMP_EXTREME_STAND_STABLE_DAMPING_BLEND_IN_S="${STABLE_DAMPING_BLEND_IN_S}" \
G1_AMP_EXTREME_STAND_STABLE_DAMPING_BLEND_OUT_S="${STABLE_DAMPING_BLEND_OUT_S}" \
G1_AMP_EXTREME_STAND_RECOVERY_DAMPING_BLEND="${RECOVERY_DAMPING_BLEND}" \
G1_AMP_EXTREME_STAND_SEVERE_DISTURBANCE_GRAVITY_XY="${SEVERE_DISTURBANCE_GRAVITY_XY}" \
G1_AMP_EXTREME_STAND_FALL_SAFETY_DAMPING_GAIN="${FALL_SAFETY_DAMPING_GAIN}" \
G1_AMP_EXTREME_STAND_TARGET_RECOVERY_LIMIT_SCALE="${TARGET_RECOVERY_LIMIT_SCALE}" \
G1_AMP_EXTREME_STAND_TARGET_SMOOTHING_ALPHA="${TARGET_SMOOTHING_ALPHA}" \
...
G1_AMP_EXTREME_STAND_TARGET_LEG_JERK_LIMIT_RAD_S3="${TARGET_LEG_JERK_LIMIT_RAD_S3}" \
G1_AMP_EXTREME_STAND_TARGET_WAIST_JERK_LIMIT_RAD_S3="${TARGET_WAIST_JERK_LIMIT_RAD_S3}" \
G1_AMP_EXTREME_STAND_TARGET_ARM_JERK_LIMIT_RAD_S3="${TARGET_ARM_JERK_LIMIT_RAD_S3}" \
...
if is_true "${GENERATE_PUSH_PLOTS}" && [[ "${PROFILE}" == "large_push" || "${PROFILE}" == "interactive" ]]; then
