...
export G1_AMP_ARMHACK_STAND_INTERACTIVE_AUTO_ENTER_S=-1.0
export G1_AMP_ARMHACK_STAND_INTERACTIVE_AUTO_SPACE_INTERVAL_S=-1.0
export G1_AMP_ARMHACK_STAND_INTERACTIVE_AUTO_SPACE_MAX_SWITCHES=0
