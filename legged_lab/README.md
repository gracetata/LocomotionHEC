...
Current default G1 task setting in this repository: only X-axis velocity command is enabled (`lin_vel_x in [-0.2, 1.5]`), `lin_vel_y=0`, `ang_vel_z=0`, and curriculum is disabled.
