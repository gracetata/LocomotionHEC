#!/usr/bin/env bash
# Preserve V4 recovery while eliminating V7's wrist-target dead zone.
...
RUN_NAME=${RUN_NAME:-g1_extreme_stand_recovery_support_lock_v8_from_v4_model2999}
...
echo "============================================================"
echo " Extreme Stand Recovery Support-Lock V8"
echo "============================================================"
...
echo "Target lock     : leg/waist gate -> full-body Top-K + arm default reward"
...
TASK=LeggedLab-Isaac-AMP-G1-ExtremeStandRecovery-SupportLockV8-v0 \
