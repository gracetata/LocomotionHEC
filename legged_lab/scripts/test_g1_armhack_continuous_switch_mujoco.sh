...
STAND_HOLD_BLEND_S=${STAND_HOLD_BLEND_S:-0.0}
STAND_HOLD_TARGET_MIX=${STAND_HOLD_TARGET_MIX:-1.0}
...
run_case() {
    ...
    G1_AMP_STAND_HOLD_BLEND_S="${STAND_HOLD_BLEND_S}" \
    G1_AMP_STAND_HOLD_TARGET_MIX="${STAND_HOLD_TARGET_MIX}" \
