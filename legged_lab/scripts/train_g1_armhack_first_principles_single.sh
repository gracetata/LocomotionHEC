...
if [[ "${MODEL}" == "stand" ]]; then
    ...
    case "${WALK_PROFILE}" in
        ...
        arm_motion) TASK=LeggedLab-Isaac-AMP-G1-ArmHackWalkArmMotionSingle-v0 ;;
        *) die "WALK_PROFILE must be acquisition, strict, robust, response, deadzone_yaw or arm_motion" ;;
    esac
