...
class RslRlAmpCfg:
    ...
    - ``policy`` keeps the historical behavior and updates from policy discriminator observations only.
    - ``policy_demo`` updates from both policy and demonstration observations.
    - ``demo_static`` initializes statistics from demonstration observations before training and freezes them.
    """
