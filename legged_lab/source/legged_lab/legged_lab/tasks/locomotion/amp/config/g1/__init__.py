...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-Nav2TwoGoalModel9996FullActor-v0",
    entry_point="legged_lab.envs:ManagerBasedAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.g1_amp_env_cfg:G1AmpNav2TwoGoalModel9996FullActorEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-Nav2TwoGoalModel9996FullActorLateralFinal-v0",
    entry_point="legged_lab.envs:ManagerBasedAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-Nav2TwoGoalModel9996FullActorLateralRobust-v0",
    entry_point="legged_lab.envs:ManagerBasedAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
