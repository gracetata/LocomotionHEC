...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackStandFirstPrinciplesCompletionSingle-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackStandFirstPrinciplesCompletionSingle-Play-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.g1_armhack_first_principles_single_env_cfg:"
            "G1ArmHackStandFirstPrinciplesCompletionSingleEnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "G1ArmHackStandFirstPrinciplesSingleRunnerCfg"
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackStandFirstPrinciplesHandoffSingle-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackStandFirstPrinciplesHandoffSingle-Play-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.g1_armhack_first_principles_single_env_cfg:"
            "G1ArmHackStandFirstPrinciplesHandoffSingleEnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "G1ArmHackStandFirstPrinciplesSingleRunnerCfg"
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackWalkFirstPrinciplesResponseSingle-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackWalkFirstPrinciplesResponseSingle-Play-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.g1_armhack_first_principles_single_env_cfg:"
            "G1ArmHackWalkFirstPrinciplesResponseSingleEnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "G1ArmHackWalkFirstPrinciplesSingleRunnerCfg"
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackWalkDeadzoneYawSingle-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.g1_armhack_first_principles_single_env_cfg:"
            "G1ArmHackWalkDeadzoneYawSingleEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "G1ArmHackWalkFirstPrinciplesSingleRunnerCfg"
...
gym.register(
    id="LeggedLab-Isaac-AMP-G1-ArmHackWalkDeadzoneYawSingle-Play-v0",
    entry_point="legged_lab.envs:G1PerturbAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.g1_armhack_first_principles_single_env_cfg:"
            "G1ArmHackWalkDeadzoneYawSingleEnvCfg_PLAY"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:"
            "G1ArmHackWalkFirstPrinciplesSingleRunnerCfg"
