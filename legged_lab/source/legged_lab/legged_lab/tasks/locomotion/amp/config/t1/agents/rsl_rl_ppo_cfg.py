...
from legged_lab.tasks.locomotion.amp.mdp.symmetry import t1
...
class T1RslRlOnPolicyRunnerAmpCfg(RslRlOnPolicyRunnerCfg):
    ...
    algorithm = RslRlPpoAmpAlgorithmCfg(
        ...
        symmetry_cfg=RslRlSymmetryCfg(
            ...
            data_augmentation_func=t1.compute_symmetric_states,
...
@configclass
class T1RslRlOnPolicyRunnerAmpDemoNormCfg(T1RslRlOnPolicyRunnerAmpCfg):
    """T1 AMP runner config that freezes discriminator normalization to demo statistics."""

    def __post_init__(self):
        self.algorithm.amp_cfg.normalizer_mode = "demo_static"
        self.algorithm.amp_cfg.demo_normalizer_init_batches = 16
